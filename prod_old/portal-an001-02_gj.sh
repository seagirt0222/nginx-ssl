...
# 只有 gj 使用域名
# portal
export DOMAIN=www.dhue1-02.gstargaming.com
systemCode
etcdctl put $PREFIX_ETCD_PORTAL/type/$DOMAIN "portal"
etcdctl put $PREFIX_ETCD_PORTAL/systemCode/$DOMAIN "an001-02"
...
# mobile 
export DOMAIN=m.dhue1-02.gstargaming.com
etcdctl put $PREFIX_ETCD_MOBILE/type/$DOMAIN "mobile"
etcdctl put $PREFIX_ETCD_MOBILE/systemCode/$DOMAIN "an001-02"
