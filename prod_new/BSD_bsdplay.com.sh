...
export DOMAIN=www.bsdplay.com
etcdctl put $PREFIX_ETCD_PORTAL/type/$DOMAIN "portal"
etcdctl put $PREFIX_ETCD_PORTAL/domain/$DOMAIN "www.bsdplay.com"
...
export DOMAIN=m.bsdplay.com
etcdctl put $PREFIX_ETCD_mobile/type/$DOMAIN "mobile"
etcdctl put $PREFIX_ETCD_mobile/domain/$DOMAIN "m.bsdplay.com"
...
export DOMAIN=agent.bsdplay.com
etcdctl put $PREFIX_ETCD_agent/type/$DOMAIN "agent"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN "agent.bsdplay.com"
...
export DOMAIN=pay.bsdplay.com
etcdctl put $PREFIX_ETCD_3p/type/$DOMAIN "thirdpartyjump"
etcdctl put $PREFIX_ETCD_3p/domain/$DOMAIN "pay.bsdplay.com"
...
export DOMAIN=portalapi.bsdplay.com
etcdctl put $PREFIX_ETCD_PORTALAPI/type/$DOMAIN "portalapi"
etcdctl put $PREFIX_ETCD_PORTALAPI/domain/$DOMAIN "portalapi.bsdplay.com"
...
export DOMAIN=master.bsdplay.com
etcdctl put $PREFIX_ETCD_master/type/$DOMAIN "master"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "master.bsdplay.com"
