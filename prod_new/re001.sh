...
# agent
export DOMAIN=agent.drs0a.let16.com
etcdctl put $PREFIX_ETCD_agent/type/$DOMAIN "agent"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN "agent.drs0a.let16.com"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN/local "agent.RE001.gjsoft.local"
etcdctl put $PREFIX_ETCD_agent/header/$DOMAIN/Host "agent.RE001.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "master.drs0a.let16.com"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN/local "master.RE001.gjsoft.local"
etcdctl put $PREFIX_ETCD_master/header/$DOMAIN/Host "master.RE001.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN "gsapi.drs0a.let16.com"
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN/local "GameSeller.RE001.gjsoft.local"
etcdctl put $PREFIX_ETCD_reseller/header/$DOMAIN/Host "GameSeller.RE001.gjsoft.local"
