...
# agent
export DOMAIN=agent.dykt3.stackcore.com
etcdctl put $PREFIX_ETCD_agent/type/$DOMAIN "agent"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN "agent.dykt3.stackcore.com"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN/local "agent.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_agent/header/$DOMAIN/Host "agent.ET003.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "master.dykt3.stackcore.com"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN/local "master.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_master/header/$DOMAIN/Host "master.ET003.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_master/type/$DOMAIN "master"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "pt2office.vui3th.com"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN/local "master.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_master/header/$DOMAIN/Host "master.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_master/upstream/$DOMAIN/1 "10.0.2.10"
etcdctl put $PREFIX_ETCD_master/subfilter/$DOMAIN/CdnRedirect 'cdn1.let16.com'
...
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN "gsapi.dykt3.stackcore.com"
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN/local "GameSeller.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_reseller/header/$DOMAIN/Host "GameSeller.ET003.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_reseller/type/$DOMAIN "reseller"
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN "pt2api.vui3th.com"
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN/local "GameSeller.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_reseller/header/$DOMAIN/Host "GameSeller.ET003.gjsoft.local"
etcdctl put $PREFIX_ETCD_reseller/upstream/$DOMAIN/1 "10.0.2.11"
etcdctl put $PREFIX_ETCD_reseller/upstream/$DOMAIN/2 "10.0.2.12"
