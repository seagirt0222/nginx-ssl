...
# agent
export DOMAIN=agent.dtk5a.let16.com
etcdctl put $PREFIX_ETCD_agent/type/$DOMAIN "agent"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN "agent.dtk5a.let16.com"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN/local "agent.RE005.gjsoft.local"
etcdctl put $PREFIX_ETCD_agent/header/$DOMAIN/Host "agent.RE005.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "master.dtk5a.let16.com"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN/local "master.RE005.gjsoft.local"
etcdctl put $PREFIX_ETCD_master/header/$DOMAIN/Host "master.RE005.gjsoft.local"
...
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN "gsapi.dtk5a.let16.com"
etcdctl put $PREFIX_ETCD_reseller/domain/$DOMAIN/local "GameSeller.RE005.gjsoft.local"
etcdctl put $PREFIX_ETCD_reseller/header/$DOMAIN/Host "GameSeller.RE005.gjsoft.local"
