...
export DOMAIN=www.bsd178.com
etcdctl put $PREFIX_ETCD_PORTAL/type/$DOMAIN "portal"
etcdctl put $PREFIX_ETCD_PORTAL/domain/$DOMAIN "www.bsd178.com"
...
export DOMAIN=m.bsd178.com
etcdctl put $PREFIX_ETCD_mobile/type/$DOMAIN "mobile"
etcdctl put $PREFIX_ETCD_mobile/domain/$DOMAIN "m.bsd178.com"
...
export DOMAIN=agent.bsd178.com
etcdctl put $PREFIX_ETCD_agent/type/$DOMAIN "agent"
etcdctl put $PREFIX_ETCD_agent/domain/$DOMAIN "agent.bsd178.com"
...
export DOMAIN=pay.bsd178.com
etcdctl put $PREFIX_ETCD_3p/type/$DOMAIN "thirdpartyjump"
etcdctl put $PREFIX_ETCD_3p/domain/$DOMAIN "pay.bsd178.com"
...
export DOMAIN=portalapi.bsd178.com
etcdctl put $PREFIX_ETCD_PORTALAPI/type/$DOMAIN "portalapi"
etcdctl put $PREFIX_ETCD_PORTALAPI/domain/$DOMAIN "portalapi.bsd178.com"
...
export DOMAIN=master.bsd178.com
etcdctl put $PREFIX_ETCD_master/type/$DOMAIN "master"
etcdctl put $PREFIX_ETCD_master/domain/$DOMAIN "master.bsd178.com"
